...
class MethodHookConfigLoaderTest {
    private companion object {
        ...
        const val TEST_PACKAGE_ID = "io.github.aleksrychkov.test"
        const val TEST_BEGIN_METHOD_WITH = "io.github.aleksrychkov.test.begin"
        const val TEST_END_METHOD_WITH = "io.github.aleksrychkov.test.end"
    }
